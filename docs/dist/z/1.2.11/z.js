...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_compress')) {
        Object.defineProperty(Module['ready'], '_compress', { configurable: true, get: function() { abort('You are getting _compress on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_compress', { configurable: true, set: function() { abort('You are setting _compress on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_compressBound')) {
        Object.defineProperty(Module['ready'], '_compressBound', { configurable: true, get: function() { abort('You are getting _compressBound on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_compressBound', { configurable: true, set: function() { abort('You are setting _compressBound on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_zlibCompileFlags')) {
        Object.defineProperty(Module['ready'], '_zlibCompileFlags', { configurable: true, get: function() { abort('You are getting _zlibCompileFlags on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_zlibCompileFlags', { configurable: true, set: function() { abort('You are setting _zlibCompileFlags on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_zlibVersion')) {
        Object.defineProperty(Module['ready'], '_zlibVersion', { configurable: true, get: function() { abort('You are getting _zlibVersion on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_zlibVersion', { configurable: true, set: function() { abort('You are setting _zlibVersion on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _compressBound = Module["_compressBound"] = createExportWrapper("compressBound");
