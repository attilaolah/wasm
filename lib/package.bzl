...
load("//lib/bison:package.bzl", "download_bison")
load("//lib/boost:package.bzl", "download_boost")
...
load("//lib/opencv:package.bzl", "download_opencv")
